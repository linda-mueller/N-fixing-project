...
#Read datasets
#--------------------
geo.ref <- readRDS("data/GIFT_geo_Aug_2023.rds") %>%
...
#Save data
#---------------------------
saveRDS(Nfix.fam.prop, "data/Nfix.fam.prop_2023.rds")
...
#Save data
#---------------------------
saveRDS(drivers, "data/Nfixdrivers_speciesnative_2023.rds")
...
#Family counts
#Read native version:
Nfix.fam.prop <- readRDS("data/Nfix.fam.prop_2023.rds")
